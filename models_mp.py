...
class Attention2(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=True, qk_scale=None, variant="dot", **kwargs):
        ...
        assert dim % num_heads == 0, 'Input dimension not divisible by number of heads'
...
class DiTBlock(nn.Module):
    ...
    def __init__(self, hidden_size, num_heads, mlp_ratio=4.0, **block_kwargs):
        ...
        self.attn = Attention2(hidden_size, num_heads=num_heads, qkv_bias=True, variant="cosine", **block_kwargs)
